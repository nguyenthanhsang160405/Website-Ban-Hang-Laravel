      ...
      <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 content">
        ...
        <form method="POST" action="/product/store" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="phone" name="price" value="{{ old('price') }}">
          </div>
          <div class="mb-3">
            @error('quantity')
                <div class="alert alert-danger">{{ $message }}</div>
            ...
            <input type="number" name="quantity" class="form-control" id="phone" value="{{ old('quantity') }}">
          </div>
          <div class="mb-3">
            @error('describe')
                <div class="alert alert-danger">{{ $message }}</div>
            ...
            <input type="text" name="describe" class="form-control" id="phone" value="{{ old('describe') }}">
          </div>
          <div class="mb-3">
            @error('category_id')
                <div class="alert alert-danger">{{ $message }}</div>
